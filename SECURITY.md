...
If you discover a security vulnerability in mcp-obsidian-bridge, please report it privately
via GitHub's Private Vulnerability Reporting:

1. Go to https://github.com/AIWander/mcp-obsidian-bridge/security
...
mcp-obsidian-bridge is under active development. Only the latest release receives security
fixes. Older releases are not supported.

## Scope

In scope:
- The mcp-obsidian-bridge binary/library and any bundled assets
